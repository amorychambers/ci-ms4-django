...
class Order(models.Model):
    ...
    delivery_cost = models.DecimalField(max_digits=6, decimal_places=2, default=5.99)
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.product.sale:
            self.lineitem_total = (self.product.price * self.product.sale) * self.quantity
        else:
    ...
    def __str__(self):
        return f"{self.product.name} for order number {self.order.order_number}"